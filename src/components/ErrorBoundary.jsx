        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="rounded-md border border-rose-200 bg-rose-50 p-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                className="px-3 py-2 text-sm font-medium rounded-md bg-rose-600 text-white hover:bg-rose-700 transition-colors"
                onClick={() => window.location.reload()}
              >
                {i18n.t('errorBoundary.reload')}
              </button>
              <button
                className="px-3 py-2 text-sm font-medium rounded-md border border-rose-200 text-rose-700 hover:bg-rose-100 transition-colors"
