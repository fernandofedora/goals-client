    ...
    <div ref={ref} className={cn('relative inline-block', className)}>
      <button
        ...
        className={cn(
          ...
          open ? 'ring-2 ring-indigo-500' : 'hover:bg-gray-50 dark:hover:bg-slate-700'
        )}
      >
      ...
      {open && (
        ...
        >
          ...
          <ul className="max-h-72 overflow-y-auto py-1">
            {categories.length === 0 && (
              <li className="px-3 py-4 text-xs text-gray-400 text-center">No categories available.</li>
            )}
            {categories.map(c => {
