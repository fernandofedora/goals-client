...
import { intlLocale, dayPickerLocale } from '../../utils/dateLocale';
    ...
    <div ref={ref} className="relative" style={{ zIndex: 50 }}>
      ...
      >
        ...
        {hasRange && (
          <span
            role="button"
            title={t('ui.dateRange.clearRange')}
            onClick={(e) => {
              e.stopPropagation();
...
const presets = [
  {
    labelKey: 'ui.dateRange.thisMonth',
    getRange: () => ({ from: startOfMonth(), to: endOfMonth() }),
  },
  {
    labelKey: 'ui.dateRange.lastMonth',
    getRange: () => {
      const t = today();
  ...
  {
    labelKey: 'ui.dateRange.last3Months',
    getRange: () => {
      const t = today();
  ...
  {
    labelKey: 'ui.dateRange.last6Months',
    getRange: () => {
      const t = today();
  ...
  {
    labelKey: 'ui.dateRange.thisYear',
    getRange: () => {
  ...
  {
    labelKey: 'ui.dateRange.lastYear',
    getRange: () => {
